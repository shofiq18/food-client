            ...
            <section className="py-10 bg-blue-50">
                <div className="container mx-auto text-center px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow">
                            <h3 className="text-4xl font-bold text-blue-500">1,000+</h3>
                            <p className="text-gray-600 mt-2">Meals Donated</p>
                        </div>
                        <div className="p-6 bg-gradient-to-r from-green-50 to-green-100 rounded-lg shadow">
                            <h3 className="text-4xl font-bold text-green-500">500+</h3>
                            <p className="text-gray-600 mt-2">Families Helped</p>
                        </div>
                        <div className="p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg shadow">
